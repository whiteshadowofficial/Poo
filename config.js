...
module.exports = {
    ...
    MENU_HEDER: process.env.MENU_HEDER === undefined ? '▢ ⇓ poo command list⇓ ▢' : process.env.MENU_HEDER,
    BOT_NAME: process.env.BOT_NAME === undefined ? '🐼 POO 🐼' : process.env.BOT_NAME,
    ...
    CAPTION_NAME: process.env.CAPTION_NAME === undefined ? '*Copyright © 2021 | Poo*' : process.env.CAPTION_NAME,
